...
export default function DeathScreen() {
	...
	const collectableCount = Number.parseInt(localStorage.getItem(`beast_collected_${gameId}`) || "0");
	...
	const tokenResult = useGameTokenRanking({
		tokenId: gameId!,
		mintedByAddress:
			currentNetworkConfig.chainId === ChainId.WP_PG_SLOT ? GAME_TOKEN_ADDRESS : addAddressPadding(dungeon.address),

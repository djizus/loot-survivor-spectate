...
import { Box, Button, Checkbox, FormControlLabel, MenuItem, Select, Slider, Typography } from "@mui/material";
		...
		<Box sx={styles.container}>
			...
			<Box sx={styles.section}>
				...
				<Box sx={{ display: "flex", flexDirection: "column" }}>
					...
					<FormControlLabel
						control={
							<Checkbox checked={fastBattle} onChange={(e) => setFastBattle(e.target.checked)} sx={styles.checkbox} />
						}

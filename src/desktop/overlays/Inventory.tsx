...
const equipmentSlots = [
	{
		key: "head" as EquipmentSlot,
		label: "Head",
		style: { top: "35px", left: "50%", transform: "translate(-50%, 0)" },
		icon: "/images/types/head.svg",
	},
	{
		key: "chest" as EquipmentSlot,
		label: "Chest",
		style: { top: "95px", left: "50%", transform: "translate(-50%, 0)" },
		icon: "/images/types/chest.svg",
	},
	{
		key: "waist" as EquipmentSlot,
		label: "Waist",
		style: { top: "155px", left: "50%", transform: "translate(-50%, 0)" },
		icon: "/images/types/waist.svg",
	},
	{
		key: "foot" as EquipmentSlot,
		label: "Foot",
		style: { top: "215px", left: "50%", transform: "translate(-50%, 0)" },
		icon: "/images/types/foot.svg",
	},
	{
		key: "hand" as EquipmentSlot,
		label: "Hands",
		style: { top: "125px", left: "8px" },
		icon: "/images/types/hand.svg",
	},
	{
		key: "ring" as EquipmentSlot,
		label: "Ring",
		style: { top: "125px", right: "8px" },
		icon: "/images/types/ring.svg",
	},
	{
		key: "weapon" as EquipmentSlot,
		label: "Weapon",
		style: { top: "185px", left: "8px" },
		icon: "/images/types/weapon.svg",
	},
		...
		<Box sx={styles.equipmentPanel}>
			<Box sx={styles.characterPortraitWrapper}>
				...
				{equipmentSlots.map((slot) => {
					...
					const isNameMatch =
						item?.id && beast ? ItemUtils.isNameMatch(item.id, level, adventurer!.item_specials_seed, beast) : false;
									...
									(beast && isArmorSlot ? (
										<Box sx={styles.tooltipContainer}>
											<Box sx={styles.emptySlotTooltipHeader}>
												<Typography sx={styles.emptySlotTooltipTitle}>Empty {slot.label} Slot</Typography>
											</Box>
								...
								{item?.id && metadata ? (
									showItemStats ? (
										...
										<Box sx={styles.itemImageContainer}>
											...
											{hasSpecials && (
												<Box
													sx={[styles.starOverlay, hasGoldSpecials ? styles.goldStarOverlay : styles.silverStarOverlay]}
												>
